...
const IfscCodeDetailsClient = ({ businessCategorydata, businessmetaheadtag , newsListData,  newsDetailsData, blogUrl }) => {
    ...
    <>
      <div className='bg-[#F4F8FB] h-auto'>
        <CommonBreadCrumbComponent
          link1='/ifsc-code'
          link1Name='IFSC Code Blogs'
          link2Name={breadCrumSlug}
          title='IFSC Code Blog Details'
        />
        <CreditNewsDetails
          blogUrl={blogUrl}
...
export default IfscCodeDetailsClient
