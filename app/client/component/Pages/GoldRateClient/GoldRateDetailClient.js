...
const GoldRateDetailClient = ({ businessCategorydata, newsDetailsData, blogUrl, newsListData }) => {
    ...
    <>
      ...
      <div className='bg-[#F4F8FB] h-auto'>
        <CommonBreadCrumbComponent
          link1='/gold-rate'
          link1Name='Gold Rate Blog'
          link2Name={breadCrumSlug}
          title='Gold Rate Blog Details'
        />
        <CreditNewsDetails
          blogUrl={blogUrl}
...
export default GoldRateDetailClient
