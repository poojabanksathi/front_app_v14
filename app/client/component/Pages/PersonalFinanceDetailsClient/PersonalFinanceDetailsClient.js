...
const PersonalFinanceDetailsClient = ({ businessCategorydata, businessmetaheadtag , newsListData,  newsDetailsData, blogUrl }) => {
...
export default PersonalFinanceDetailsClient
