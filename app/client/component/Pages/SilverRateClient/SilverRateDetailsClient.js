...
const SilverRateDetailsClient = ({ businessCategorydata, businessmetaheadtag , newsListData,  newsDetailsData, blogUrl }) => {
    ...
    <>
      ...
      <div className='bg-[#F4F8FB] h-auto'>
        <CommonBreadCrumbComponent
          link1='/silver-rate'
          link1Name='Silver Rate Blogs'
          link2Name={breadCrumSlug}
          title='Silver Rate Blog Details'
        />
        <CreditNewsDetails
          blogUrl={blogUrl}
...
export default SilverRateDetailsClient