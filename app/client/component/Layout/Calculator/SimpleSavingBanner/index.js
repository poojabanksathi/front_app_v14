...
import SimpleSaving from '../../../../../public/assets/simple-saving-icon.svg'


function SimpleSavingBanner() {
  ...
  return (
    <>
        ...
        <div
          className={`container h-full  mx-auto max-[991px]:max-w-full py-[80px] max-[834px]:py-[35px] max-[576px]:py-[52px] max-[479px]:py-[20px] max-[1024px]:px-8 max-[479px]:px-4 max-[375px]:px-4 max-[320px]:px-4 ${scrollY > 0 ? 'scroll-banner' : 'scroll-same'
            }`}>
...
export default SimpleSavingBanner
