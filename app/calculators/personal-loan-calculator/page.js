...
const PersonalCalculatorDetails = dynamic(
  () =>
    import(
      "@/app/client/component/common/CalculatorCards/PersonalCalculatorDetails"
    ),
  {
    ssr: false,
  }
...
async function getData() {
  try {
    const lang_id = 1;
    const context_params = "personal-loan-calculator";
  ...
  return (
    <>
      <div className="bg-[#F4F8FB] h-auto">
        <BredcrumbCalculator />
        <PersonalCalculatorDetails metaData={businessmetaheadtag} />
        <FAQ faqdata={faqdata} />
      </div>
    </>
  );
