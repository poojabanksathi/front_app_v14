...
const EPFCalculator = dynamic(
  () => import("@/app/client/component/common/CalculatorCards/EPFCalculator"),
  {
    ssr: false,
  }
);
...
async function getData() {
  try {
    const lang_id = 1;
    const context_params = "epf-calculator";
  ...
  return (
    <>
      <div className="bg-[#F4F8FB] h-auto">
        <BredcrumbCalculator />
        <EPFCalculator metaData={businessmetaheadtag} />
        <FAQ faqdata={faqdata} />
      </div>
    </>
  );
