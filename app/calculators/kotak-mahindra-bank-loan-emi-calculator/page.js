...
async function getData() {
  try {
    const lang_id = 1;
    const context_params = "kotak-mahindra-bank-loan-emi-calculator";
    ...
    <>
      <div className="bg-[#F4F8FB] h-auto">
        ...
        <PersonalLoanCalculator
          ...
          calculatorName={"Kotak Mahindra Bank Personal Loan EMI Calculator"}
          info={"Plan Your Loans, Control Your Future"}
          loanname={"kotak-mahindra-bank-loan"}
        />
        <FAQ faqdata={faqdata} />
      </div>
    </>
